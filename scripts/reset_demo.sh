...
#   borra alertas, viajes y cupos de ensayo, vuelve a cargar los conductores de demo y regenera
#   los datos FICTICIOS del tablero de analítica (60 días, marcados demo:* / demo-*).
#   (No borra usuarios reales ni los números vinculados de Telegram.)
...
docker compose exec -T backend python -m scripts.seed_analitica
docker compose restart backend >/dev/null   # limpia también la memoria del chat
echo "✅ Demo listo: sin alertas, con conductores y viajes de ejemplo, y el tablero de analítica poblado."
