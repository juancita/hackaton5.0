...
self.addEventListener('fetch', (e) => {
  ...
  const esApi = !esExterno && /^\/(health|network|places|routes|chat|webhooks|incident-types|incidents|reporters|admin|docs|redoc|openapi\.json)(\/|$)/.test(url.pathname);
